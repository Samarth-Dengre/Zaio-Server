...
// insert data into twoHours collection
module.exports.insertTwoHours = async () => {
  try {
    let totalDuration = 0;
    let temp = [];
    let day = 1;
    for (let course of courses) {
      if (totalDuration + course.duration >= 120) {
        const twoHours = new TwoHours({
          day: day,
...
// insert data into fourHours collection
module.exports.insertFourHours = async () => {
  try {
    let totalDuration = 0;
    let temp = [];
    let day = 1;
    for (let course of courses) {
      if (totalDuration + course.duration >= 240) {
        const fourHours = new FourHours({
          day: day,
          duration: totalDuration,
          modules: temp,
        });
        await fourHours.save();
        totalDuration = 0;
        temp = [];
        day++;
      }
...
// insert data into sixHours collection
module.exports.insertSixHours = async () => {
  try {
    let totalDuration = 0;
    let temp = [];
    let day = 1;
    for (let course of courses) {
      if (totalDuration + course.duration >= 360) {
        const sixHours = new SixHours({
          day: day,
          duration: totalDuration,
          modules: temp,
        });
